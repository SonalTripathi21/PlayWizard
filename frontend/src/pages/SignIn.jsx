...
function SignIn() {
  ...
  const handleSignIn = async (e) => {
    ...
    const mockUser = { name, email: `${name.toLowerCase()}@example.com` };
    localStorage.setItem('user', JSON.stringify(mockUser));
    
    // Log the event to backend
    try {
        await api.post('/api/auth/log', { identifier: name, type: 'signin' });
    } catch (err) {
  ...
  return (
    <div className="auth-container">
      ...
      <div className="glass-card auth-card floating">
        ...
        <p className="auth-subtitle">Sign in to continue to PlayWizard</p>
        ...
        <form onSubmit={handleSignIn} className="auth-form">
          ...
          <button type="submit" className="cta-primary auth-submit">Sign In</button>
        </form>
